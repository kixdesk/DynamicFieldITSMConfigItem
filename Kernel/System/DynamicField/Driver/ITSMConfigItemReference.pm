...
sub PossibleValuesGet {
    ...
    my @ITSMConfigItemClasses = @{$Param{DynamicFieldConfig}->{Config}->{ITSMConfigItemClasses}};
...
sub EditFieldRender {
    ...
    my $ValueString = join(',', @{ $SelectedValuesArrayRef });
    ...
    <div class="InputField_Container W50pc">
        ...
        <input id="$ValidateFieldName" type="text" class="$FieldClass" value="$ValueString" style="display: none;" />
